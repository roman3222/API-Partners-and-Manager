...
from backend.serializers import (
    ...
    LoginUserSerializer,
    TokenSerializer,
    CartSchemaSerializer,
    CartItemSchemaSerializer,
    ...
    post=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                response=UserSerializer, description="Created"
            ),
...
class RegisterUserAccount(APIView):
    ...
    def post(self, request: HttpRequest, *args, **kwargs) -> JsonResponse:
        ...
        if {
            ...
            try:
                ...
                if user_serializer.is_valid():
                    ...
                    return JsonResponse(
                        {"Status": True, "Created": user_serializer.data}
                    )
        ...
        return JsonResponse(
            {"Status": False, "Error": "All the necessary arguments are not stated"},
            status=400,
        )
    ...
    def post(self, request: HttpRequest, *args, **kwargs) -> JsonResponse:
        if {"email", "token"}.issubset(request.data):
            ...
            if token:
                ...
                token.delete()
                return JsonResponse(
                    {"Status": True, "Message": "Email confirmed"}, status=200
                )

            return JsonResponse(
                {"Status": False, "Errors": "Incorrect email or token"}, status=400
            )

        return JsonResponse(
            {"Status": False, "Errors": "All the necessary arguments are not stated"},
            status=400,
        )
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            ...
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Токен не передан или токен неверный"
            ),
            status.HTTP_500_INTERNAL_SERVER_ERROR: OpenApiResponse(response=None),
        },
    ),
    post=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                response=UserSerializer, description="Confirmed Update"
            ),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Токен не передан или токен неверный"
            ),
...
class AccountDetails(APIView):
    ...
    def get(self, request, *args, **kwargs):
        if not request.user.is_authenticated:
            return JsonResponse(
                {"Status": False, "Error": "log in required"}, status=401
            )
        ...
        if "password" in request.data:
            ...
            try:
                ...
                for item in password_error:
                    error_array.append(item)
                return JsonResponse(
                    {"Status": False, "Errors": {"password": error_array}}, status=400
                )
            else:
...
@extend_schema_view(
    post=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                response=TokenSerializer, description="Your Token"
            ),
            status.HTTP_400_BAD_REQUEST: OpenApiResponse(
                description="Bad request(something invalid"
            ),
        ...
        if {"email", "password"}.issubset(request.data):
            ...
            if user is not None:
                if user.is_active:
                    ...
                    return JsonResponse(
                        {"Status": True, "Token": token.key}, status=200
                    )

            return JsonResponse(
                {"Status": False, "Errors": "User not found or e-mail unconfirmed"},
                status=404,
            )
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                CategorySerializer, description="Status: True"
            ),
            status.HTTP_500_INTERNAL_SERVER_ERROR: OpenApiResponse(response=None),
        },
    )
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(ShopSerializer, description="OK"),
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                ProductInfoSerializer, description="OK"
            ),
            status.HTTP_500_INTERNAL_SERVER_ERROR: OpenApiResponse(response=None),
            status.HTTP_400_BAD_REQUEST: OpenApiResponse(
                description="Bad request(something invalid)"
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(CartItemSerializer, description="OK"),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
    ...
    patch=extend_schema(
        ...
        responses={
            ...
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Check your Token Authorization"
            ),
            status.HTTP_500_INTERNAL_SERVER_ERROR: OpenApiResponse(response=None),
        },
    ),
...
class CartView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not request.user.is_authenticated:
            return JsonResponse(
                {"Status": False, "Errors": "Log in is required"}, status=403
            )
        ...
        if serializer.is_valid():
            ...
            for item_data in cart_item_data:
                ...
                try:
                    ...
                    return JsonResponse(
                        {"Status": False, "Errors": "cart not found"}, status=404
                    )
                ...
                try:
                    ...
                    return JsonResponse(
                        {"Status": False, "error": "Product Info not found"}, status=404
                    )
    ...
    def patch(self, request, *args, **kwargs):
        ...
        if not request.user.is_authenticated:
            return JsonResponse(
                {"Status": False, "Errors": "Log in is required"}, status=401
            )
        ...
        try:
            ...
            return JsonResponse(
                {"Status": False, "Errors": "cart item not found"}, status=404
            )
        ...
        if quantity < 1:
            cart_item.delete()
            return JsonResponse(
                {"Status": True, "message": "Cart item was delete"}, status=201
            )
        ...
        if url:
            ...
            for item in data["goods"]:
                ...
                return JsonResponse(
                    {
                        "Status": False,
                        "Errors": "All the necessary arguments are not stated",
                    }
                )
...
@extend_schema_view(
    ...
    post=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(ShopSerializer, description="Created"),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Check your Token Authorization"
            ),
            status.HTTP_400_BAD_REQUEST: OpenApiResponse(
    ...
    patch=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(ShopSerializer, description="Update"),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Check your Token Authorization"
            ),
            status.HTTP_400_BAD_REQUEST: OpenApiResponse(
...
class PartnerShop(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.type != "shop":
            return JsonResponse(
                {"Status": False, "Errors": "Only for partners"}, status=403
            )
    ...
    def post(self, request, *args, **kwargs):
        if "name" in request.data:
            if not request.user.is_authenticated:
                return JsonResponse(
                    {"Status": False, "Errors": "Log in required"}, status=401
                )

            if request.user.type != "shop":
                return JsonResponse(
                    {"Status": False, "Errors": "Only for partners"}, status=401
                )
            ...
            if shop.is_valid():
                ...
                return JsonResponse(
                    {"Status": False, "Errors": shop.errors}, status=400
                )

        return JsonResponse(
            {"Status": False, "Errors": "The name of the store is not specified"},
            status=400,
        )
    ...
    def patch(self, request, *args, **kwargs):
        if not request.user.is_authenticated:
            return JsonResponse(
                {"Status": False, "Errors": "Log in required"}, status=403
            )
        ...
        try:
            ...
            return JsonResponse(
                {"Status": True, "updates": serializer_shop.data}, status=200
            )
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(ContactsSerializer, description="OK"),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Check your Token Authorization"
            ),
            status.HTTP_500_INTERNAL_SERVER_ERROR: OpenApiResponse(response=None),
    ...
    put=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(
                ContactsSerializer, description="Update"
            ),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Check your Token Authorization"
            ),
...
class ContactView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        if not request.user.is_authenticated:
            return JsonResponse(
                {"Status": False, "Error": "log in is required"}, status=403
            )
    ...
    def post(self, request, *args, **kwargs):
        if not request.user.is_authenticated:
            return JsonResponse(
                {"Status": False, "Error": "log in is required"}, status=401
            )
        ...
        if {"city", "street", "phone"}.issubset(request.data):
            ...
            if contact_serializer.is_valid():
                ...
                return JsonResponse(
                    {"Status": True, "your contacts": contact_serializer.data},
                    status=200,
                )
            else:
                return JsonResponse(
                    {"Status": False, "Error": contact_serializer.errors}, status=400
                )
...
@extend_schema_view(
    get=extend_schema(
        ...
        responses={
            status.HTTP_200_OK: OpenApiResponse(OrderSerializer, description="OK"),
            status.HTTP_401_UNAUTHORIZED: OpenApiResponse(
                description="Check your Token Authorization"
            ),
        ...
        if {"contact", "cart_item"}.issubset(request.data):
            ...
            with transaction.atomic():
                ...
                for cart_item in cart_items:
                    ...
                    updated_product_info = ProductInfo.objects.get(
                        id=cart_item.product_info.id
                    )
...
class PartnerOrders(APIView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.user.type != "shop":
            return JsonResponse(
                {"Status": False, "Error": "Only for shops"}, status=403
            )
    ...
    def patch(self, request, *args, **kwargs):
        ...
        if request.user.type != "shop":
            return JsonResponse(
                {"Status": False, "Error": "Only for partners"}, status=401
            )
        ...
        if {"order", "state"}.issubset(request.data):
            ...
            try:
                ...
                return JsonResponse(
                    {"Status": False, "Error": "Order not found"}, status=404
                )
            ...
            return JsonResponse(
                {
                    "Status": False,
                    "Error": "All the necessary arguments are not stated",
                },
                status=400,
            )
        ...
        if serializer.is_valid():
            ...
            if not password == password_confirm:
                return JsonResponse(
                    {
                        "Status": False,
                        "Error": "Поле password не совпадает с полем password_confirm",
                    }
                )
            ...
            return JsonResponse(
                {"Status": False, "Error": "The token has expired."}, status=400
            )
