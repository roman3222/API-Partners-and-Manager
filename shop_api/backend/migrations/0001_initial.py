    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'A user with that username already exists'}, help_text='Required. 100 characters or fewer. Letters, digits and @/./+/-/_ only.', max_length=100, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
                ('email_confirmed', models.BooleanField(default=False, help_text='Email Confirmation Status', verbose_name='Подтверждение почты')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cart', models.ForeignKey(blank=True, default=None, on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='backend.cart', verbose_name='Корзина')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.PositiveIntegerField(blank=True, unique=True, verbose_name='Внешний ИД')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveIntegerField(verbose_name='Количество')),
                ('price', models.PositiveIntegerField(blank=True, null=True, verbose_name='Цена(на момент создания заказа)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_info', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='cart_product', to='backend.productinfo', verbose_name='Информация о продукте')),
            ],
            options={
